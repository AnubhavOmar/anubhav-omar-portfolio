    ...
    >
        <div className='container mx-auto px-6'>
            ...
            <p className='text-gray-400 text-center max-w-2xl mx-auto mb-16'>
                Technologies, tools, and concepts I use to build projects and strengthen my development skills.
            </p>

            {/* Cards in My Skills Section */}
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-5xl mx-auto'>
                {
                    skills.map( (skill,index)=>(
                            <div key = {index} className='bg-dark-300 rounded-2xl p-6 hover:-translate-y-2 transition duration-300 cursor-pointer'> {/* Ye wala box ke leye ho gaya */}
